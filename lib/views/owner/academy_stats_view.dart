      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          if (constraints.maxWidth > 1200) {
            horizontalPadding =
                constraints.maxWidth * 0.1; // 10% padding on large screens
          } else if (constraints.maxWidth > 800) {
            horizontalPadding = 32; // Fixed padding for medium screens
          }
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              // Quick stats grid - responsive for web
                              LayoutBuilder(
                                builder: (context, constraints) {
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Revenue cards - responsive for web
                  LayoutBuilder(
                    builder: (context, constraints) {
                      // Determine grid layout based on screen width
                      int crossAxisCount = 2;
                            ...
                            child: Row(
                              children: [
                                ...
                                if (payments.length > 5) ...[
                                  const SizedBox(width: 8),
                                  TextButton(
                                    onPressed: () => _showAllPaymentsDialog(
                                      context,
                                      payments,
                                    ),
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Basic attendance info - responsive for web
                  LayoutBuilder(
                    builder: (context, constraints) {
                      // Determine layout based on screen width
                      if (constraints.maxWidth > 800) {
                        // Desktop - use row with equal spacing
                        return Row(
                          children: [
                            Expanded(
                            ...
                            const SizedBox(width: 16),
                            // Add empty expanded widgets to center the cards
                            Expanded(child: Container()),
                            Expanded(child: Container()),
                          ],
                        );
                      } else {
                        // Mobile/tablet - use original row
                        return Row(
                          children: [
                            Expanded(
                              child: _buildAttendanceCard(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // Academic overview - responsive for web
                          LayoutBuilder(
                            builder: (context, constraints) {
                              // Determine layout based on screen width
                              if (constraints.maxWidth > 800) {
  ...
  Widget _buildStatCard(
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        double padding = constraints.maxWidth > 200 ? 16 : 12;
        double iconSize = constraints.maxWidth > 200 ? 24 : 20;
        double valueSize = constraints.maxWidth > 200 ? 24 : 20;
        double titleSize = constraints.maxWidth > 200 ? 12 : 11;
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              Container(
                padding: EdgeInsets.all(constraints.maxWidth > 200 ? 12 : 8),
                decoration: BoxDecoration(
                  color: color.withOpacity(0.1),
                  borderRadius: BorderRadius.circular(12),
                ),
              ...
              SizedBox(height: constraints.maxWidth > 200 ? 12 : 8),
              Flexible(
                child: Text(
                  value,
                  style: TextStyle(
              ...
              SizedBox(height: constraints.maxWidth > 200 ? 4 : 2),
              Flexible(
                child: Text(
                  title,
                  style: TextStyle(
  ...
  Widget _buildRevenueCard(
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        // Responsive sizing based on available width
        double padding = constraints.maxWidth > 200 ? 16 : 12;
        double iconSize = constraints.maxWidth > 200 ? 28 : 24;
        double valueSize = constraints.maxWidth > 200 ? 18 : 16;
        double titleSize = constraints.maxWidth > 200 ? 12 : 11;
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: constraints.maxWidth > 200 ? 8 : 6),
              Flexible(
                child: Text(
                  value,
                  style: TextStyle(
